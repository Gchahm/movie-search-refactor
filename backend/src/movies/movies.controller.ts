...
import {SearchMoviesResponse, FavoritesResponse} from "@movie-search/types";
...
export class MoviesController {
    ...
    @Get('search')
    async searchMovies(@Query() queryDto: SearchMoviesQueryDto): Promise<SearchMoviesResponse> {
    ...
    @Get('favorites/list')
    getFavorites(@Query() queryDto: GetFavoritesQueryDto): Promise<FavoritesResponse> {
